    ...
    fetch("https://script.google.com/macros/s/AKfycbxbXW5WQUBvyo4YhyPuvpQLuLC30nVqRwUPbGTrdMNuW1t35wDFakJ04nhApvWCem8/exec?phone=" + encodeURIComponent(phoneNumber), { cache: "no-store" })
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                document.getElementById("message").innerHTML = `Nomor HP belum terdaftar, registrasi dulu di </br> <a href="https://forms.gle/WJWFGg69V8WtSjqf7" target="_blank">https://forms.gle/WJWFGg69V8WtSjqf7</a>`;
            }            
